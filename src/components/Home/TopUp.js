            ...
            <View style={styles.modalContainer}>
                ...
                <View style={styles.bottomContainer}>
                    <View style={styles.cardInfoRow}>
                        ...
                        <Text style={{fontSize: 14, color: Colors.muted, marginLeft: -40}}>Donald Tramp</Text>
                        <Button style={{borderColor: Colors.primary, borderRadius: 0}} small transparent><Text style={{paddingHorizontal: 10, fontSize: 11, color: Colors.primary}}>View</Text></Button>
                    </View>
